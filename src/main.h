...
static const int64 MAX_MONEY = 42400000 * COIN; // REGA: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 0.25) / 250; // REGA: Priority cutoff is 2 REGA day / 250 bytes.
    }
