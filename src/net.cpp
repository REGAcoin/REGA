...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "REGA " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    ...
    {"cryptolife.net","electrum3.cryptolife.net"},
    {"cryptolife.net","seed4.cryptolife.net"},
    {"51.255.38.250","51.255.38.250"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. REGA is probably already running."), addrBind.ToString().c_str());
        else
